...
## I pushed new Rev 2.1 gerbers to github just now (November 20, 2021). The silkscreen of the original upload was missing the footprint values (e.g. 1k, 0.1uF, etc). Everything else was correct. Only the silkscreen was affected. If downloaded the gerbers since Rev 2.1 was pushed, you should download them again.
